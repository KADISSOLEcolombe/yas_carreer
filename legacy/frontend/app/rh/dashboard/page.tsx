...
export default function RHDashboardPage() {
  ...
  const STAT_CARDS = [
    { label: 'Offres publiées', value: stats.offresCount, icon: Briefcase, bg: '#DBEAFE', color: '#00377D' },
    ...
    { label: 'Entretiens planifiés', value: stats.entretiensCount || 0, icon: UserCheck, bg: '#D1FAE5', color: '#065F46' },
  ];
