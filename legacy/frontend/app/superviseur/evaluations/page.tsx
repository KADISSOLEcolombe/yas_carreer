                ...
                <div key={item.id} className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
                  ...
                  {item.fichier_rapport && (
                    <div className="mt-3 rounded-xl border border-slate-100 bg-white p-3">
                      <p className="mb-1 text-xs font-semibold uppercase tracking-wide text-slate-400">Rapport</p>
                      <p className="text-sm text-slate-700 whitespace-pre-line">{item.fichier_rapport}</p>
                    </div>
                  )}
                </div>
              );
