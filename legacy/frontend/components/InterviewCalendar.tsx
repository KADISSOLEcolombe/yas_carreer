  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-200">
        <h2 className="text-lg font-semibold capitalize text-yas-midnight">
      ...
      <div className="grid grid-cols-7">
        {days.map((date, index) => {
          ...
          return (
            ...
            >
              <span
                className={`inline-flex size-7 items-center justify-center rounded-full text-sm font-medium mb-1 ${
              ...
              {dayInterviews.length > 0 && (
                <div className="space-y-0.5">
                  ...
                  {scheduledCount > 0 && (
                    <p className="text-[10px] font-medium text-yas-midnight sm:hidden">
